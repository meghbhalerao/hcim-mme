...
cd ..
python main.py --method MME --dataset multi --source real --target sketch --net alexnet --loss CE --attribute glove.twitter.27B.50d.txt --dim 50 --save_check

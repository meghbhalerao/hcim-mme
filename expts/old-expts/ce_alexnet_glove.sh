...
cd ..
python main.py --method MME --dataset multi --source real --target sketch --net alexnet --attribute glove_anurag --dim 50 --loss CBFL --deep 0 --patience 10 --mode train --save_check

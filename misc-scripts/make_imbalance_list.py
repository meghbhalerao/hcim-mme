...
f = open("../data/txt/multi_mini_balanced/labeled_source_images_real.txt","r")
...
img_num_per_cls = get_img_num_per_cls(total_examples,num_classes,"step",0.1)
